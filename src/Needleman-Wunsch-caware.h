 ...
 */
/**
 * \fn long EditDistance_NW_Caware(char* A, size_t lengthA, char* B, size_t lengthB);
 ...
 *
 * editDistance_NW_Caware is a cache aware immplementatioin of Needleman-Wunsch algorithm.
 *
 */
